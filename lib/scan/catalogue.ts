...
const INLINE_CHECKS = {
  ...
  transport: 7,
  /** gradeFundamentals: https, mixed-content, viewport, title, description, OG, canonical. */
  fundamentals: 7,
  /** analyzeAccessibility: form labels, control names, zoom, lang, landmark, tabindex, duplicate ids, iframe titles, skip link. */
  accessibility: 9,
